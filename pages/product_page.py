...
class ProductsPageLocators:
    ...
    PRODUCT_NAME_XPATH_PATTERN: str = (
        "//android.widget.TextView[@content-desc='Product Title' and @text='{product_name}']"
    )
    ...
    PRODUCT_NAME: Tuple[str, str] = field(default=(AppiumBy.XPATH, PRODUCT_NAME_XPATH_PATTERN), init=False)

...
class CartPageLocators:
	...
	PRODUCT_NAME: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/titleTV"),
		init=False
	)
	PRODUCT_COLOR: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/colorIV"),
		init=False
	)
	...
	PRIVACY_POLICY: Tuple[str, str] = field(
		default=(AppiumBy.ID, "//android.widget.TextView[@text='© 2023 Sauce Labs All Rights Reserved. Terms of Service | Privacy Policy']"),
		init=False
	)
	ITEMS_COUNT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/itemsTV"),
		init=False
	)
	TOTAL_AMOUNT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/totalPriceTV"),
		init=False
	)
	...
	REMOVE_ITEM_BUTTON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/removeBt"),
		init=False
	)

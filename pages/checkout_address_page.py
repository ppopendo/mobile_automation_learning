...
class CheckoutAddressPageLocators:
	...
	FIRST_NAME_INPUT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/fullNameET"),
		init=False
	)
	ADDRESS_LINE_1_INPUT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/address1ET"),
		init=False
	)
	ADDRESS_LINE_2_INPUT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/address2ET"),
		init=False
	)
	CITY_INPUT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/cityET"),
		init=False
	)
	STATE_REGION_INPUT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/stateET"),
		init=False
	)
	ZIP_CODE_INPUT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/zipET"),
		init=False
	)
	COUNTRY_INPUT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/countryET"),
		init=False
	)
	...
	FULL_NAME_ERROR_MESSAGE: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/fullNameErrorTV"),
		init=False
	)
	FULL_NAME_ERROR_ICON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/fullNameErrorIV"),
		init=False
	)
	ADDRESS_LINE_1_ERROR_MESSAGE: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/address1ErrorTV"),
		init=False
	)
	ADDRESS_LINE_1_ERROR_ICON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/address1ErrorIV"),
		init=False
	)
	CITY_ERROR_MESSAGE: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/cityErrorTV"),
		init=False
	)
	CITY_ERROR_ICON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/cityIV"),
		init=False
	)
	ZIP_CODE_ERROR_MESSAGE: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/zipErrorTV"),
		init=False
	)
	ZIP_CODE_ERROR_ICON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/zipIV"),
		init=False
	)
	COUNTRY_ERROR_MESSAGE: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/countryErrorTV"),
		init=False
	)
	COUNTRY_ERROR_ICON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/countryIV"),
		init=False
	)
...
class CheckoutAddressPage(BasePage):
	...
	def wait_until_page_is_loaded(self, timeout=10) -> None:
		expected_locators = [
			CheckoutAddressPageLocators.PAGE_HEADER,
			CheckoutAddressPageLocators.FIRST_NAME_INPUT,
			CheckoutAddressPageLocators.ADDRESS_LINE_1_INPUT,
			CheckoutAddressPageLocators.CITY_INPUT,
			CheckoutAddressPageLocators.ZIP_CODE_INPUT,
			CheckoutAddressPageLocators.COUNTRY_INPUT,
			CheckoutAddressPageLocators.TO_PAYMENT_BUTTON,
		]
	...
	def enter_shipping_address(self, first_name: str, address_line_1: str, city: str, zip_code: str, country: str) -> None:

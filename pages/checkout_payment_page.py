...
class CheckoutPaymentPageLocators:
	PAGE_HEADER: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/enterPaymentTitleTV"),
		init=False
	)
	PAGE_SUB_TITLE: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/enterPaymentMethodTV"),
		init=False
	)
	CARD_HEADER: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/cardTV"),
		init=False
	)
	...
	CARD_NUMBER_INPUT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/cardNumberET"),
		init=False
	)
	EXPIRATION_DATE_INPUT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/expirationDateET"),
		init=False
	)
	SECURITY_CODE_INPUT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/securityCodeET"),
		init=False
	)
	BILLING_ADDRESS_SAME_AS_SHIPPING_CHECKBOX: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/billingAddressCB"),
		init=False
	)
	...
	FULL_NAME_ERROR_ICON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/nameErrorIV"),
		init=False
	)
	CARD_NUMBER_ERROR_ICON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/cardNumberErrorIV"),
		init=False
	)
	EXPIRATION_DATE_ERROR_MESSAGE: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/expirationDateErrorTV"),
		init=False
	)
	EXPIRATION_DATE_ERROR_ICON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/expirationDateIV"),
		init=False
	)
	SECURITY_CODE_ERROR_MESSAGE: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/securityCodeErrorTV"),
		init=False
	)
	SECURITY_CODE_ERROR_ICON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/securityCodeIV"),
		init=False
	)
...
class CheckoutPaymentPage(BasePage):
	...
	def enter_payment_information(self, full_name: str, card_number: str, expiration_date: str, security_code: str, billing_address_same_as_shipping: bool = False) -> None:

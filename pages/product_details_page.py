...
class ProductDetailsPageLocators:
	PRODUCT_COLOR: Tuple[str, str] = field(
		default=(AppiumBy.XPATH, "//android.widget.ImageView[@content-desc='{product_color}']"),
		init=False
	)
	PRODUCT_PRICE: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/priceTV"),
		init=False
	)
	PRODUCT_DESCRIPTION: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/descTV"),
		init=False
	)
	PRODUCT_HIGHLIGHTS: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/productHeightLightsTV"),
		init=False
	)
	INCREASE_QUANTITY_BUTTON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/plusIV"),
		init=False
	)
	DECREASE_QUANTITY_BUTTON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/minusIV"),
		init=False
	)
	COUNT_ITEM: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/noTV"),
		init=False
	)
	ADD_TO_CART_BUTTON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/cartBt"),
		init=False
	)
	CART_ICON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/cartIV"),
		init=False
	)
	COUNT_ITEM_IN_CART: Tuple[str, str] = field(
		default=(AppiumBy.XPATH, "//android.widget.RelativeLayout[@content-desc='Displays number of items in your cart']/android.widget.ImageView"),
		init=False
	)
	...
	COUNT_ITEM_IN_CART_VALUE: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/cartTV"),
		init=False
	)

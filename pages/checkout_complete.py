...
class CheckoutCompletePageLocators:
	PAGE_HEADER: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/completeTV"),
		init=False
	)
	SUB_HEADER: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/thankYouTV"),
		init=False
	)
	SWAG_TXT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/swagTV"),
		init=False
	)
	ORDER_INFORMATION_TXT: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/orderTV"),
		init=False
	)
	CONTINUE_SHOPPING_BUTTON: Tuple[str, str] = field(
		default=(AppiumBy.ID, "com.saucelabs.mydemoapp.android:id/shoopingBt"),
		init=False
	)
...
class CheckoutCompletePage(BasePage):
	...
	def is_order_successful(self) -> bool:
		...
		checkout_complete_messages = ["Checkout Complete", "Thank you for your order","Your new swag is on its way", "Your order has been dispatched and will arrive as fast as the pony gallops!"]

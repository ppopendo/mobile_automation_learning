...
class TestNativeViewDemo:
    ...
    def test_native_view_containers_text_content(self, native_view_demo_page: NativeViewDemoPage) -> None:
        ...
        actual = {
            "container_1_has_content": native_view_demo_page.container_text_1.strip(),
            "container_2_has_content": native_view_demo_page.container_text_2.strip(),
            "container_3_has_content": native_view_demo_page.container_text_3.strip(),
        }
        expected = {
            "container_1_has_content": "Hello World, I'm View one",
            "container_2_has_content": "Hello World, I'm View two",
            "container_3_has_content": "Hello World, I'm View three",
        }

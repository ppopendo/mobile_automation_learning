...
class TestDragAndDrop:
    ...
    def test_drag_and_drop_element_to_element(self, drag_and_drop_page: DragAndDropPage) -> None:
        ...
        # Assert - verify elements still exist after drag
        assert drag_and_drop_page.is_drag_me_button_displayed, "Drag me button should still exist"
        assert drag_and_drop_page.is_drop_here_zone_displayed, "Drop here zone should still exist"
    ...
    def test_drag_and_drop_with_different_speeds(self, drag_and_drop_page: DragAndDropPage, speed: int) -> None:
        ...
        # Assert - verify elements still exist
        assert (
            drag_and_drop_page.is_drag_me_button_displayed
        ), f"Drag me button should exist after drag at {speed} speed"

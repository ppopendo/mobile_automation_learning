...
class TestDragAndDrop:
    ...
    def test_drag_and_drop_element_to_element(self, drag_and_drop_page: DragAndDropPage) -> None:
        ...
        """
        drag_and_drop_page.drag_and_drop_element()
        assert (
            drag_and_drop_page.message_dropped_text == "Circle dropped"
        ), "Drop confirmation message should have correct text"
    ...
    def test_drag_and_drop_with_different_speeds(self, drag_and_drop_page: DragAndDropPage, speed: int) -> None:
        ...
        drag_and_drop_page.drag_and_drop_element(speed=speed)
        # Assert - verify elements were visible
        assert drag_and_drop_page.is_message_dropped_displayed, "Drop confirmation message should be displayed"

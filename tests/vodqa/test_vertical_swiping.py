...
class TestVerticalSwiping:
    ...
    def test_swipe_up_gesture(self, vertical_swiping_page: VerticalSwipingPage) -> None:
        ...
        initial_item_visible = vertical_swiping_page.is_item_displayed("C")
        # Act - perform swipe up gesture
        vertical_swiping_page.swipe_up(locator=None, percentage=0.75, speed=2500)
        # Assert - verify operation completed (initial item may or may not be visible after swipe)
        assert initial_item_visible, "Item 'C' should be visible initially"
    ...
    def test_swipe_down_gesture(self, vertical_swiping_page: VerticalSwipingPage) -> None:
        ...
        assert vertical_swiping_page.is_item_displayed("Karma"), "Item 'Karma' should be visible after operations"
